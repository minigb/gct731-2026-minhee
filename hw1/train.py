...
def build_experiment_config(
    ...
    return {
        ...
        "optimization": {
            ...
            "scheduler": {
                "name": str(cfg.optimization.scheduler.name),
                "min_learning_rate": float(cfg.optimization.scheduler.min_learning_rate),
                "step_size": int(cfg.optimization.scheduler.step_size),
                "gamma": float(cfg.optimization.scheduler.gamma),
            },
        },
        "wandb_usage": {
...
def main(cfg: DictConfig) -> None:
    ...
    runner = Runner(
        ...
        scheduler_name=str(cfg.optimization.scheduler.name),
        scheduler_min_lr=float(cfg.optimization.scheduler.min_learning_rate),
        scheduler_step_size=int(cfg.optimization.scheduler.step_size),
        scheduler_gamma=float(cfg.optimization.scheduler.gamma),
        offset_loss_weight=float(cfg.optimization.offset_loss_weight),
